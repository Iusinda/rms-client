...
public class ChooseRestaurant extends ActionBarActivity {
    ...
    private void initialization() {
        ...
        linearLayout = (LinearLayout) findViewById(R.id.chooseRestaurantLL);
        ...
        linearLayout.setOnClickListener(hideKeyboardListener);
        ...
        restaurantList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.i("Item from rest List :", ((HashMap) parent.getAdapter().getItem(position)).get("id").toString());
                Intent intent = new Intent(getApplicationContext(), ChooseSize.class);
                intent.putExtra("areaId", areaId);
                intent.putExtra("districtId", districtId);
                intent.putExtra("restaurantId", ((HashMap) parent.getAdapter().getItem(position)).get("id").toString());
                intent.setClass(getApplicationContext(), ChooseSize.class);
        ...
        protected void onPostExecute(String result) {
            ...
            if (Error != null)
                ...
                try {
                    ...
                    Log.i("Array Length :", jsonArray.length() + "");
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(ChooseRestaurant.this, android.R.layout.simple_spinner_item, areaItems);
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            areaDropdown.setAdapter(adapter);
            ArrayAdapter<String> idAdapter = new ArrayAdapter<String>(ChooseRestaurant.this, android.R.layout.simple_spinner_item, areaIds);
    ...
    private class getDistricts extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(ChooseRestaurant.this, android.R.layout.simple_spinner_item, districtItems);
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            districtDropdown.setAdapter(adapter);
            ArrayAdapter<String> idAdapter = new ArrayAdapter<String>(ChooseRestaurant.this, android.R.layout.simple_spinner_item, districtIds);
            idAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private class getRestaurants extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            ListAdapter adapter = new SimpleAdapter(ChooseRestaurant.this, restaurantItems,
    ...
    private class registerCustomer extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String content) {
            ...
            try {
                ...
                Log.i("Object from post is : ", jsonObj.toString());
                customerId = jsonObj.optString("id");
                storeCustomerId(getApplicationContext(), customerId);
